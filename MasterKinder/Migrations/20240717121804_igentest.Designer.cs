...
namespace MasterKinder.Migrations
{
    ...
    [Migration("20240717121804_igentest")]
    partial class igentest
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MasterKinder.Models.BlogPost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MasterKinder.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MasterKinder.Models.BlogPost", b =>
                {
                    b.HasOne("MasterKinder.Models.Category", "Category")
                        .WithMany("BlogPosts")
